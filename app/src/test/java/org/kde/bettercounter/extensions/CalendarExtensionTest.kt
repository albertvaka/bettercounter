...
class CalendarExtensionTest {
    ...
    fun `week truncation respects the first day of the week in US locale`() {
        ...
        val sundayDate = Date(1697995920502).toCalendar() // Sunday 22 October 2023 17:32:00.502 UTC
        val mondayDate = Date(1691995920502).toCalendar() // Monday 14 August 2023 6:52:00.502 UTC
        sundayDate.truncate(Calendar.WEEK_OF_YEAR)
        mondayDate.truncate(Calendar.WEEK_OF_YEAR)
